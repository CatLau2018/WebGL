...
lib.ssMetadata = [
		{name:"FirstPage_atlas_", frames: [[0,744,440,440],[442,744,440,440],[0,0,720,300],[0,302,440,440],[442,302,440,440]]}
];
...
(lib.basket = function() {
	this.spriteSheet = ss["FirstPage_atlas_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/FirstPage_atlas_.png", id:"FirstPage_atlas_"}
	],
	preloads: []
};
